...
<section class="masthead clearfix">
    <h2 class="masthead-timeline">The Timeline</h2>
</section>
<section class="timeline timeline-2 clearfix">
<div id="slider-loading-wrapper"><div id="slider-loading-img"></div><p>Loading data...</p></div>
<div id="embed-timeline" class="embed-timeline">
</div>
</section>
...
<!--
  <section class="timeline timeline-2 clearfix">
    <div class="weekly-timeline clearfix">
      <div class="embed-timeline"></div>
      <div class="summary-contents clearfix">
        <article class="weekly-summary clearfix">
          <h2 class="weekly-summary-title">Week 3 Summary</h2>
        ...
        <div class="weekly-objects">
          <h2 class="weekly-objects-title">Week 3 Objects</h2>
          <ul>
            <li class="_container-11">
              <a href="#" class="_text-1">list of object 1</a>
            </li>
            <li class="_container-12">
              <a href="#" class="_text-2">list of object 1</a>
            </li>
            <li class="_container-14">
              <a href="#" class="_text-3">list of object 1</a>
            </li>
          </ul>
        </div>
      </div>
