  ...
  <section class="objects objects-2">
    <div class="object-contents clearfix">
      <div class="object clearfix">
        ...
        <img class="object-item" src="/NapoleonOmeka/themes/Napoleon-Theme/images/image-placeholder-550-470x278.jpg" data-rimage data-src="/NapoleonOmeka/themes/Napoleon-Theme/images/image-placeholder-550-470x278.jpg">
        <h6 class="object-source">Source: Unidentified</h6>
        <h6 class="object-permission">Permission: Eleifend option congue nihil imperdiet doming id quod mazim placerat facer possim. Quinta decima eodem modo typi qui nunc nobis videntur parum, clari fiant sollemnes.</h6>
      </div>
      <h4 class="link-to-weekly-summary clearfix">
        <a href="#">Go to Weekly Summary</a>
      </h4>
      <div class="location clearfix">
        <h2 class="location-title">Location</h2>
        <div class="object-location clearfix">
          <img class="object-map" src="/NapoleonOmeka/themes/Napoleon-Theme/images/map-placeholder-550-470x168.jpg" data-rimage data-src="/NapoleonOmeka/themes/Napoleon-Theme/images/map-placeholder-550-470x168.jpg">
        </div>
      </div>
      <div class="object-description object-description-1 clearfix">
        <h2 class="object-title">Napoleon Leaving Elba</h2>
        <h6 class="contributed-by">Contributed by: Anonymous</h6>
        ...
        <button class="more-info">For further information, click here</button>
      </div>
      <div class="related-links related-links-1 clearfix">
        <h2 class="related-links">Related Links</h2>
        <ul class="clearfix">
          <li class="clearfix">
            <a href="#">list of related links</a>
          </li>
        </ul>
      </div>
    </div>
